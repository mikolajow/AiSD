...
public class test {
	...
	public static void main(String[] args) {
		...
		*/
		...
		System.out.println("Warto�� Maxymalna = " + test.getLista().get(test.getLista().size() -1) );
		System.out.println("Warto�� Minimalna = " + test.getLista().get(0) );
		...
		System.out.println("Warto�� Maxymalna = " + test2.getLista().get(test2.getLista().size() -1) );
		System.out.println("Warto�� Minimalna = " + test2.getLista().get(0) );
